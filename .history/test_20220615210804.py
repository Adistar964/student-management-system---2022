...
def op_win(op):
    ...
    password = Entry(r,show="*", font=Font(size=10))
...
def main_window():
    ...
    for i in ops:
        Button(r, bg="lightblue", fg="black",text=i+" Student", font=Font(size=12), command=lambda op=i: op_win(op)).pack(ipady=10,ipadx=17, pady=10)
    r.mainloop()

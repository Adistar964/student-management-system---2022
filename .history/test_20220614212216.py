...
def login_win():
    ...
    Label(r, text="Admin Login", bg="black", fg="white",font=Font(underline=True, size=25)).pack(pady=10)
    Label(r, text="", bg="black").pack(pady=20)
    Label(r, text="Username", bg="black", fg="white").pack()
    username = Entry(r, font=Font(size=12))
    username.pack()
    Label(r, text="Password", bg="black", fg="white").pack()
    password = Entry(r, font=Font(size=12))
    password.pack()
    Button(r, text="login", command=login, bg="green",fg="white").pack(pady=20)
    r.mainloop()

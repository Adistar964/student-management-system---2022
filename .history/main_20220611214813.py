...
def update_student(info):
    ...
    menu = OptionMenu(r, value_of_menu, *data)
    ...
    Button(r, text="update", bg="green", fg="white", font=Font(size=12)).grid(row=1,columnspan=2,column=0, ipadx=20, ipady=15, pady=12)
    r.mainloop()

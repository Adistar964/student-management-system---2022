...
def login_win():
    ...
    Label(r, text="Admin Login", font=Font(underline=True, size=25)).pack(pady=10)
    Label(r, text="").pack(pady=20)
    Label(r, text="Username").pack()
    username = Entry(r, font=Font(size=12))
    username.pack()
    Label(r, text="Password").pack()
    password = Entry(r, font=Font(size=12))
    password.pack()
    Button(r, text="login", command=login).pack(pady=20)
    r.mainloop()

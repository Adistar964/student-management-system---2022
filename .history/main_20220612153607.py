...
def create_student():
    ...
    r.resizable(0,0)
    Label(r, text="Create New Student").grid(row=0,column=0,columnspan=2,pady=12)
    ...
    for idx,i in enumerate(data):
        ...
        Label(frame, text=i.replace("_", " "), bg="white", fg="black").pack()
        Entry(frame).pack(ipady=10, ipadx=20)
    r.mainloop()

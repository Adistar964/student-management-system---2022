...
def main_window():
    ...
    Button(r, bg="lightblue",fg="white",text="Create Student", command=create_student).pack(pady=10,ipady=15, ipadx=25)
    ops = ["update","search","delete"]
    for i in ops:
        Button(r, bg="lightblue",fg="white",text=i+" Student", command=lambda i=i:op_win(i)).pack(pady=10,ipady=15, ipadx=25)
    r.mainloop()

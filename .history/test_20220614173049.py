...
def main_window():
    ...
    ops = ["create","update","search","delete","some other "]
    for op in ops:
        Button(r, text=op+" student", command=lambda i=op:op_menu(i)).pack(pady=10)

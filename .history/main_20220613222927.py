...
def create_student():
    ...
    Button(r, text="Create", font=Font(size=15), bg="darkgreen",fg="white").pack(anchor="center", pady=10, ipady=10, ipadx=20)
    r.mainloop()
...
def login_window():
    ...
    title = Label(r, text="Admin Login", bg="black", fg="white", font=Font(size=28, underline=True, family="bauhaumas 93"))
    title.pack(ipady=15)

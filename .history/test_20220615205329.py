...
def main_window():
    ...
    Button(r, text="Create Student", font=Font(size=10), command=lambda:create_student()).pack(ipady=10,ipadx=17, pady=10)
    ops = ["Update","Search","Delete"]
    for i in ops:
        Button(r, text=i+" Student", font=Font(size=10), command=lambda i=i:op_win(i)).pack(ipady=10,ipadx=17, pady=10)
    r.mainloop()
